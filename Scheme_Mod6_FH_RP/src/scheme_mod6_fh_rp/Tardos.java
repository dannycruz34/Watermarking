...
public class Tardos {
    ...
    public ArrayList accusation(boolean[][] codeMatrix,
        ...
        if(sum > Z){
            id.add(i);
            System.out.println("Umbral (Z):\t" + sum); 
            System.out.println("User:\t" + i );
            System.out.println("# Bits de huella recuperados:\t" + coincidencias);
            System.out.println("Porcentaje de recuperacion:\t" + ((coincidencias * 100)/(float)lengthOfCodes ));
            System.out.println(coincidencias +"\t"+ ((coincidencias * 100)/(float)lengthOfCodes ) +"\t\t"+sum+"\t\t"+i );
        }
